            ...
            <div className="md:col-span-5 relative">
              <div className="relative rounded-2xl overflow-hidden shadow-lg border-4 border-white aspect-3/4 max-w-sm mx-auto bg-slate-200">
                ...
                <div className="absolute bottom-4 left-4 right-4 text-center bg-white/95 backdrop-blur-md rounded-xl py-2 px-3 shadow-md border border-white/60">
                  <p className="text-xs font-bold text-[#10233F]">IELTS 8.0 Official</p>
                  <p className="text-[10px] text-slate-500 font-medium">Đối tác khảo thí IDP Vietnam</p>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-7 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm font-semibold text-[#2563EB] mt-0.5">
                  Cử nhân Sư phạm Tiếng Anh • Đại học Sư phạm TP.HCM
                </p>
              </div>

              <p className="text-sm sm:text-base text-slate-600 leading-relaxed">
                Với hơn 8 năm chuyên sâu luyện thi IELTS và tiếng Anh học thuật, Thầy Harry Khôi kiên định theo đuổi phương pháp giảng dạy thực chất, tập trung sửa từng lỗi phát âm và bẻ gãy từng câu văn chưa chuẩn xác, giúp học viên tiến bộ vững chắc mà không học vẹt.
              </p>
              ...
              <div className="space-y-2.5 pt-2">
                <div className="flex items-center gap-2.5 text-xs sm:text-sm font-medium text-slate-700">
                  ...
                  <span>Chứng chỉ Nghiệp vụ Sư phạm Quốc tế TESOL Standard</span>
                </div>
                <div className="flex items-center gap-2.5 text-xs sm:text-sm font-medium text-slate-700">
                  <ShieldCheck className="w-4 h-4 text-[#2563EB] shrink-0" />
                  <span>Đối tác chính thức đào tạo và đăng ký thi cùng IDP IELTS</span>
                </div>
                <div className="flex items-center gap-2.5 text-xs sm:text-sm font-medium text-slate-700">
                  <BookOpen className="w-4 h-4 text-[#2563EB] shrink-0" />
                  <span>Trực tiếp chấm chữa 1-1 không giới hạn số lượng bài viết</span>
                </div>
              </div>
