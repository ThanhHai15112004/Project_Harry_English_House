        ...
        <div className="bg-white rounded-2xl p-6 sm:p-10 border border-[#E2E8F0] shadow-sm relative">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-slate-100">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-xs font-bold text-slate-500">
                  Thời lượng: {currentItem.duration}
                </span>
              </div>
            ...
            <div className="shrink-0 flex items-center gap-2">
              <span className="text-xs font-bold text-slate-400">Giai đoạn {activeStage + 1} / {roadmap.length}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-6">
            ...
            <div className="lg:col-span-5 bg-[#F8FAFC] rounded-xl p-5 border border-slate-200/70">
              <h4 className="text-xs font-bold text-[#1746A2] uppercase tracking-wider mb-3 flex items-center gap-1.5">
                ...
                {t('pages.courseDetail.roadmap.focusLabel', 'Trọng tâm giai đoạn:')}
              </h4>
              <ul className="space-y-2.5">
                {(currentItem.focus || []).map((focusItem, fIdx) => (
                  <li key={focusItem} className="flex items-center gap-2 text-sm font-medium text-slate-700">
