          ...
          <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md p-4 sm:p-5 rounded-3xl shadow-xl border border-slate-200/90 dark:border-slate-700 space-y-4 max-w-3xl mx-auto">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-10 py-3.5 bg-slate-50 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-700 rounded-2xl text-slate-800 dark:text-slate-100 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary dark:focus:ring-sky-400 text-sm font-medium transition-all shadow-inner"
              />
              {searchTerm && (
                <button
                  type="button"
                  onClick={() => onSearchChange('')}
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 p-1.5 rounded-full text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 hover:bg-slate-200/60 dark:hover:bg-slate-700 transition-colors cursor-pointer"
                  title={t('dictation.home.exercises.clearSearch')}
                >
