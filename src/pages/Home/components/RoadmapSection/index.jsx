  ...
  const roadmapData = {
    ielts: [
      ...
      },
      {
        ...
        curriculum: ['Cambridge IELTS 15-18', 'IELTS Advantage', 'Bộ đề dự đoán HIU'],
    ...
    communication: [
      {
        ...
        curriculum: ['Pronunciation in Use', 'English Grammar', 'Mẫu câu phản xạ độc quyền HIU'],
      ...
      },
      {
        ...
        curriculum: ['Business Speaking English', 'English File Intermediate', 'Tình huống công sở HIU'],
