/**
 * Application & Brand Information Constants
 */
export const APP_INFO = {
  ...
  FOUNDER: {
    ...
    EXPERIENCE_YEARS: '8+',
    TEACHING_STANDARD: '7.5+ IELTS Team',
  ...
  CONTACT: {
    ...
    LOCATIONS: [
      ...
      'Quận 1',
      'Quận 10',
      'Online toàn quốc (Google Meet / Zoom)',
    ],
  },
  SOCIAL_LINKS: {
    ...
    INSTAGRAM: 'https://www.instagram.com/_k.pedia_',
    THREADS: 'https://www.threads.com/@_k.pedia_',
  },
};
